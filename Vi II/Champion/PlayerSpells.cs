    ...
    internal static class PlayerSpells
    {
        ...
        public static void Game_OnProcessSpell(Obj_AI_Base unit, GameObjectProcessSpellCastEventArgs spell)
        {
            ...
            if (CastList.Count >= 2)
            {
                ...
                {
                    Utility.DelayAction.Add(250, () => AutoAttackCount = 1);
                }
                ...
                {
                    Utility.DelayAction.Add(250, () => AutoAttackCount = 0);
            ...
            switch (spell.Slot)
            {
                case SpellSlot.R:
                {
                        Utility.DelayAction.Add(10, () => LastSpellCastTick = Environment.TickCount);
                        Utility.DelayAction.Add(10, () => AutoAttackCount = 0);
                        Orbwalking.ResetAutoAttackTimer();
                    break;
                }
            }
